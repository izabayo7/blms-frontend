<template>
  <div
    ...
    :class="{
      'pt-7':
        (!participationInfo.isOfferingCourse || isStudentPresenting) &&
        !$vuetify.breakpoint.mobile,
    }"
  >
    <div
      v-if="loaded && !error"
      class="live-class--wrapper"
      :class="{
        'mx-auto': !participationInfo.isOfferingCourse || isStudentPresenting,
      }"
    >
      <back
        v-if="!participationInfo.isOfferingCourse || isStudentPresenting"
        target="/"
      ...
      <div class="live-class--video" :class="`--${$vuetify.breakpoint.name}`">
          ...
          <div class="video--wrapper">
            <div
              ...
              :class="`--${$vuetify.breakpoint.name} ${
                sidebarOpen ? '' : 'viewer'
              } ${participationInfo.isOfferingCourse ? '' : 'mx-auto'}`"
            ...
            >
              <div
                ...
                v-show="
                  (noVideo && !isPresenting) ||
                  (isPresenting &&
                    participationInfo.isOfferingCourse &&
                    (currentPresenter
                      ? currentPresenter._id == me.userInfo._id
                      : true))
                "
              >
                <div
                  class="no-video--wrapper"
                ...
                >
                  <div
                    v-if="
                      isStudentPresenting ||
                      (currentPresenter
                        ? currentPresenter.category == 'STUDENT'
                        : false)
                    "
                    ...
                    <h2 class="name">
                      {{
                        isStudentPresenting
                          ...
                          : `${
                              currentPresenter
                                ? currentPresenter.sur_name +
                                  " " +
                                  currentPresenter.other_names
                                : ""
                            }`
                      }}
                    </h2>
                  ...
                  <div v-else-if="instructor" class="instructor-info">
                    ...
                    <h2 class="course">
                      {{ live_session.course.name }}:
                      {{ live_session.chapter.name }}
                    </h2>
              ...
              <transition name="fade">
                <div
                  :class="`overlay ${noVideo ? 'none' : ''}`"
                  v-show="showMenu || (noVideo && !isPresenting)"
                >
                      ...
                      <div class="d-flex" v-if="currentPresenter || instructor">
                        <div class="profile">
                          <img
                            v-if="
                              currentPresenter
                                ? currentPresenter.profile
                                : instructor.profile
                            "
                            :src="
                              currentPresenter
                                ? currentPresenter.profile + '?width=100'
                        ...
                        <button
                          v-if="
                            userCategory != 'STUDENT' && !isStudentPresenting
                          "
                          @click="stop_presenter"
                    ...
                    <div class="heading d-flex">
                      <button @click="toogleComments" class="toogle-comments">
                        ...
                        <span
                          v-if="!showComments"
                          class="unread"
                          :class="{ active: newCommentAvailable }"
                        >
                      ...
                      <div v-if="showComments" class="title">LIVE COMMENTS</div>
                      <button
                        @click="toogleComments"
                        class="toogle-comments"
                        :class="{ 'ml-auto': showComments }"
                      >
                        <svg
                          v-if="showComments"
                          width="24"
                  ...
                  <div
                    ...
                    v-if="
                      participationInfo.isOfferingCourse &&
                      (currentPresenter
                        ? currentPresenter._id == this.me.userInfo._id
                        : true)
                    "
                  >
                    <div
                      class="video-controls--wrapper"
                      :class="`${showComments ? '' : 'centered'} ${
                        $vuetify.breakpoint.mobile ? 'wide' : ''
                      }`"
                    >
                      <button @click="toogleVideo" class="start-mute-video">
                        <span class="icon">
                          ...
                          >
                            <path
                              d="M24.9992 3.17969L17.3633 8.63395L24.9992 14.0882V3.17969Z"
                              stroke="white"
                      ...
                      <button @click="toogleAudio" class="start-mute-mic">
                        <span class="icon">
                          ...
                          >
                            ...
                            />
                            <path
                              d="M1.64453 17.8301L21.8692 2.96492"
                              stroke="white"
                              stroke-width="1.37952"
                              stroke-linecap="round"
                              stroke-linejoin="round"
                      ...
                      <button
                        v-if="
                          isStudentPresenting && !$vuetify.breakpoint.mobile
                        "
                        @click="stop_presenting"
                        class="start-settings"
                      >
                        <span class="icon">
                          <svg
                  ...
                  >
                    <div class="live-class-details--wrapper">
                      <div class="description">
                        {{ live_session.chapter.description }}
                      </div>
                      <div class="d-flex">
                        <div v-if="displayQuiz && quiz" class="quiz ml-auto">
                          <button @click="openQuiz">Take quiz</button>
                        </div>
                        <button
                          v-if="instructor"
                          @click="
                            requestPresenting(!isHandRaised, instructor._id)
                          "
                          class="raise-hand"
                          :class="{ 'mt-2': !(displayQuiz && quiz) }"
                        >
                          <div class="icon d-flex justify-center">
                            ...
                            >
                              <path
                                d="M35.8231 33.4513L36.089 22.4272C36.1311 20.6851 34.7525 19.258 33.01 19.2398C31.2674 19.2216 29.8207 20.6191 29.7787 22.3613L29.5638 31.2679L28.6358 31.2582L29.2268 6.76171C29.2688 5.01954 27.8903 3.59252 26.1477 3.57431C24.4051 3.55609 22.9585 4.95358 22.9164 6.69575L22.5269 22.8424L21.5989 22.8327L22.0626 3.61107C22.1047 1.8689 20.7262 0.441885 18.9836 0.423669C17.241 0.405453 15.7943 1.80294 15.7523 3.54511L15.2886 22.7666L14.3606 22.7569L14.7501 6.61031C14.7921 4.86814 13.4136 3.44113 11.671 3.42291C9.92843 3.40469 8.48171 4.80224 8.43974 6.54435L8.05013 22.6909L7.12214 22.6812L7.43047 9.9011C7.47251 8.15893 6.094 6.73191 4.35141 6.71369C2.60883 6.69548 1.16218 8.09296 1.12014 9.83513L0.559277 33.0826C0.397592 39.7842 5.71952 45.2934 12.4228 45.3635L23.3732 45.478C30.0764 45.5481 35.6613 40.1529 35.8231 33.4513Z"
                                fill="#FFAE34"
                              />
                            </svg>
                            <svg
                  ...
                  >
                    <div class="video-controls--wrapper viewer wide centered">
                      ...
                      <button @click="toogleFullScreen" class="ml-auto">
                        ...
                        >
                          <path
                            d="M6.72526 1H1.30859V6.41667"
                            stroke="white"
                            stroke-width="1.26923"
                          />
                          <path
                            d="M15.8906 1H21.3073V6.41667"
                            stroke="white"
                            stroke-width="1.26923"
                          />
                          <path
                            d="M21.3073 10.25V15.6667H15.8906"
                            stroke="white"
                            stroke-width="1.26923"
                          />
                          <path
                            d="M1.30859 10.25V15.6667H6.72526"
                            stroke="white"
                            stroke-width="1.26923"
                          />
                        </svg>
        ...
        <div
          ...
          class="live-class-details non-absolute"
        >
          <div class="live-class-details--wrapper white">
            <h2 class="hidden-md-and-up">
              {{ live_session.course.name }}: Chapter
            </h2>
            <div class="description">
              {{ live_session.chapter.description }}
            </div>
            <div class="d-flex">
              <div v-if="displayQuiz && quiz" class="quiz d-flex align-center">
                <button class="mt-0" @click="openQuiz">Take quiz</button>
              </div>
              <button
                v-if="instructor"
                @click="requestPresenting(!isHandRaised, instructor._id)"
                class="raise-hand"
              >
                <div class="icon d-flex justify-center">
                  <svg
      ...
      <div
        v-if="participationInfo.isOfferingCourse && !isStudentPresenting"
        class="live-class--attendance"
        :class="{
          'mt-0': userCategory == 'STUDENT' && $vuetify.breakpoint.mobile,
        }"
      >
        <div class="live-class--attendance--wrapper">
          ...
          <div class="online-users">
            <online-user
              v-for="user in participants.filter(
                (x) => x.userInfo.category != 'INSTRUCTOR'
              )"
              :user="user.userInfo"
            ...
            <button
              @click="
                set_modal({
                  ...
                  method: {
                    action: 'live_session/change_confirmation',
                    parameters: { value: 'end_class' },
                  },
...
<script src="./liveClass.js"></script>
