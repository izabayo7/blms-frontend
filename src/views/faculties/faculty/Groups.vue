                  ...
                  <table-action-burner >
                    <template #icon>
                      <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.875 9.78135V12.1251H3.21875L10.1312 5.2126L7.7875 2.86885L0.875 9.78135ZM11.9437 3.4001C12.1875 3.15635 12.1875 2.7626 11.9437 2.51885L10.4813 1.05635C10.2375 0.812598 9.84375 0.812598 9.6 1.05635L8.45625 2.2001L10.8 4.54385L11.9437 3.4001Z" fill="#193074"/>
                      </svg>
                    </template>
...
name: "FacultyGroups",
  ...
  mounted(){
    this.$store.dispatch('faculty_college_year/getFacultyCollegeYearsByFaculty',{facultyId:this.facultyId})
