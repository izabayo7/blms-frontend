              ...
              >
                ...
                <div v-if="question.type === 'file_upload'" class="file-container row">
                  ...
                  <div class="pick-file file-picked col-12 col-md-8 d-flex px-4">
                    <button @click="downloadAttachment(`${backend_url}/api/quiz_submission/${selected_quiz_submission._id}/attachment/${attempt.answers[i].src}?token=${$session.get('jwt')}`)" class="file-name">
