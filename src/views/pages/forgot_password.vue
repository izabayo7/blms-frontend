        ...
        <div class="login-box mx-auto text-center">
          <div class="heading">
            ...
            <div class="lower-message">
              <div class="message-row">Don’t have an account contact us ? <a href="/register">Register</a></div>
              <div class="message-row">Remembered your password ? <a href="/login">Login</a></div>
              <div class="message-row">Having trouble resseting your password ?</div>
            </div>
          </div>
        </div>
      </v-col>
