<template>
  <v-container fluid class="home-page">
    <v-row>
      <v-col cols="12" class="mt-12 hidden-md-and-up">
        <v-img class="home-page-image" :src="require('@/assets/images/Classroom-rafiki.svg')" />
      </v-col>
      ...
      <v-col cols="12" md="6" class="home-image-side hidden-sm-and-down">
        <v-img
