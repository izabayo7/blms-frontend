              ...
              <div class="hidden-sm-and-down">
                <div class="d-flex">
                  <div class="details">
                    ...
                    <div class="action"><button>Iyandikishe</button></div>
                    <div
                      v-if="selectedCourse.haveCertificate"
                      class="certificate d-flex align-center"
                    >
                      <svg
                        width="46"
                        height="46"
...
export default {
  ...
  data() {
    return {
      ...
      navigationState: [{ name: "Courses", path: "/college_profile" }],
      selectedCourse: {
        name: "Ubumenyi ngiro",
        language: "English",
        haveCertificate: true,
  ...
  mounted() {
    ...
    this.navigationState.push({
      ...
      path: `/schools/${this.college.id}/${this.selectedCourse.id}`,
    });
  },
};
</script>
