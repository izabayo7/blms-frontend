  ...
  <v-container fluid class="reset-password-page">
    <v-row>
      <v-col class="col-12 mx-auto col-md-6">
        <div
          v-if="password_reset"
          class="reset-password-box mx-auto text-center"
        >
          <div class="heading">
        ...
        <div
          v-else
          class="reset-password-box mx-auto d-flex align-center justify-center"
        >
          <div>
            {{ message }}
            <div class="lower-message">
              <div class="message-row mt-4">
                <router-link to="/login"
                  ><button class="login-button mx-auto">
                    Back to login
                  </button></router-link
                >
              </div>
    ...
    validateConfirmPassword() {
      ...
      if (str.length)
        if (this.obj.new_password === str)
          this.errors.confirmPasswordError = "";
        else this.errors.confirmPasswordError = "Passwords must match";
      else
