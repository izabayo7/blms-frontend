      ...
      <div class="col-12">
        ...
        <div v-else class="empty-faculties mt-md-10">
          <div class="wrapper">
            ...
            <div class="title">No announcement</div>
            <div class="subtitle">To create and send an announcement <br>  click the button bellow
            </div>
            <button @click="$router.push('/announcements/new')" class="action">
