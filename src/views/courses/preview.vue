            ...
            <span class="text-h1 white--text">{{
              course.name | computeText
                ...
                <div class="preview-content col-sm-12 col-md-12 col-lg-8 col-xl-8">
                        ...
                        <article class="action-btns">
                            <v-tooltip content-class="top tooltip" top>
                                <template v-slot:activator="{ attrs, on }">
                                    <div
                                            @click=" course.chapters.length ? $router.push(`/courses/${course.name}`) : undefined"
                                            :class="`act-btn preview ${course.chapters.length ? '' : 'disabled'}`"
                                            v-bind="attrs"
                                            v-on="on"
                                    >
                                        <svg
                    ...
                    "
                                            :class="`act-btn upload ${course.chapters.length ? '' : 'disabled'}`"
                                            v-bind="attrs"
                                            v-on="on"
                                    >
                                        <svg
