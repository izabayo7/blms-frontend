<template>
  <v-app id="admin-dashboard">
      <h2>Welcome, <strong>Ahmed Mugu</strong></h2>
      <v-row>
          ...
          <v-col class="col-md-3 col-12">
              <v-card class="school-card">
                   <v-row>
                       <v-col class="col-12"><h1>A</h1></v-col>
                       <v-col class="col-12">
      ...
      <v-row>
        <v-card class="users-table">
            ...
            <v-text-field
                ...
                hide-details
            ></v-text-field>
            <v-btn rounded @click="$router.push(`/user-registration`)"><v-icon>mdi-account-plus-outline</v-icon> Add new user</v-btn>
            </v-card-title>
            <v-data-table
                    :headers="headers"
                    :items="items"
