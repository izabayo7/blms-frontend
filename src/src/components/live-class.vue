          ...
          >
            <v-row>
              <v-col class="col-12" id="video">
                <kurious-video
                  poster="http://127.0.0.1:5500/src/assets/images/live.png"
                  src="https://player.vimeo.com/external/194837908.sd.mp4?s=c350076905b78c67f74d7ee39fdb4fef01d12420&profile_id=164"
                />
              </v-col>
              <v-col class=" col-12 course-title d-block">{{courseName}}<span class="video-status"  v-if="$store.state.user.category === 'Student'" >live</span></v-col>
