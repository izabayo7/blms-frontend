      ...
      <div class="mds--panel">
        <div class="mds--panel--selection">
          ...
          <div class="mds--panel--selection--media mds--panel--selection--media--audio-in">
            <div >
              <span>Audion input</span>
              <span>
                  <svg width="10" height="11" viewBox="0 0 10 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5.70766 0.620117V10.1612H6.90039V0.620117H5.70766ZM3.32296 1.81285V8.96847H4.51569V1.81285H3.32296ZM8.09312 3.00558V7.77574H9.28585V3.00558H8.09312ZM0.9375 4.19831V6.58301H2.13023V4.19831H0.9375Z" fill="#646464"/>
                  </svg>
              </span>
            </div>
