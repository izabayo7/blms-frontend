                ...
                <div class="comment">
                    ...
                    <div class="replies" v-if=" (content.replies !== undefined && content.replies.length > 0)">
                        ...
                        <div class="comment-replies" v-if="reply_visible">
                            <div class="comment-reply" v-for="reply in content.replies" :key="reply._id"><reply-comment :verified="reply.sender.category !== 'STUDENT'" :content="reply" /></div>
                        </div>
                    </div>
