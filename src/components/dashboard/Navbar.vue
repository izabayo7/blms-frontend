<template>
  <div class="my-navbar row">
    ...
    <!-- <div class="hidden-md-and-up col-2 vertically--centered">
      <v-btn
        dark
        icon
    ...
    <div
      v-if="showCreateCourseButton"
      class="create_course col-2 col-md-1 vertically--centered"
    >
      <v-btn
        rounded
        dark
    ...
    <div
      :class="`notification   col-1 ${
        !showCreateCourseButton ? '' : 'offset-lg-1'
      }`"
    >
      <notifications />
    </div>
