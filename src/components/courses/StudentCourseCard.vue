            ...
            <v-row class="card-content">
                <v-col cols="5" class="course-image-side">
                    <v-img
                            ...
                            :src="`${course.cover_picture}?format=png&width=200&height=200&token=${$session.get('jwt')}`"
                            :lazy-src="`${course.cover_picture}?format=png&width=200&height=200&token=${$session.get('jwt')}`"
                            class="course-image"
                    >
