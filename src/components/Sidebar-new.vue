<template>
    <div class="sidebar">
        <div class="toogle"> <v-icon large>mdi-menu</v-icon></div>
        <div class="routes mt-15"> 
            <ul ref="nav">
                <div class="active-link"> </div>
                <li @click="setActive(0)" :class="{active:active == 0}"> <router-link to="/courses" >
                  <svg xmlns="http://www.w3.org/2000/svg" width="101.875" height="87.321" viewBox="0 0 101.875 87.321">
                ...
                <li @click="setActive(1)" :class="{active:active == 1}" > <router-link to="/reports" >
                  <svg xmlns="http://www.w3.org/2000/svg" width="100" height="122.268" viewBox="0 0 100 122.268">
                ...
                <li @click="setActive(2)" :class="{active:active == 2}" > <router-link  to="/library" >
                  <svg xmlns="http://www.w3.org/2000/svg" width="174.421" height="121.839" viewBox="0 0 174.421 121.839">
                    <path id="Icon_metro-books" data-name="Icon metro-books" d="M38.108,8.571H7.648a5.092,5.092,0,0,0-5.077,5.077V125.334a5.092,5.092,0,0,0,5.077,5.077h30.46a5.092,5.092,0,0,0,5.077-5.077V13.648a5.092,5.092,0,0,0-5.077-5.077Zm-5.077,30.46H12.725V28.878H33.031V39.031ZM88.874,8.571H58.414a5.092,5.092,0,0,0-5.077,5.077V125.334a5.092,5.092,0,0,0,5.077,5.077h30.46a5.092,5.092,0,0,0,5.077-5.077V13.648a5.092,5.092,0,0,0-5.077-5.077ZM83.8,39.031H63.491V28.878H83.8Zm40.151-22.61-27.2,13.706A5.092,5.092,0,0,0,94.5,36.945l45.686,90.673c1.256,2.494,4.324,3.506,34.02-11.456a5.092,5.092,0,0,0,2.249-6.818L130.766,18.671a5.092,5.092,0,0,0-6.818-2.25Z" transform="translate(-2.571 -8.571)"/>
                  </svg>

                </router-link> </li>
                <li @click="setActive(3)" :class="{active:active == 3}" > <router-link to="/messages" >
                  <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100">
                    <path id="Icon_material-message" data-name="Icon material-message" d="M93,3H13A9.987,9.987,0,0,0,3.05,13L3,103,23,83H93a10.029,10.029,0,0,0,10-10V13A10.029,10.029,0,0,0,93,3ZM83,63H23V53H83Zm0-15H23V38H83Zm0-15H23V23H83Z" transform="translate(-3 -3)"/>
                  </svg>

                </router-link> </li>
                <li @click="setActive(4)" :class="{active:active == 4}" > <router-link  to="/quiz" >
                  <svg xmlns="http://www.w3.org/2000/svg" width="100" height="99.998" viewBox="0 0 100 99.998">
                    <path id="Icon_ionic-md-settings" data-name="Icon ionic-md-settings" d="M91.347,58.374a31.268,31.268,0,0,0,.255-5c0-1.75-.255-3.249-.255-5l10.737-8.249a2.3,2.3,0,0,0,.512-3.249L92.368,19.625a2.49,2.49,0,0,0-3.069-1l-12.785,5a37.216,37.216,0,0,0-8.692-5L66.032,5.375a2.74,2.74,0,0,0-2.557-2H43.019a2.74,2.74,0,0,0-2.557,2L38.416,18.624a43.3,43.3,0,0,0-8.695,5l-12.785-5a2.4,2.4,0,0,0-3.069,1L3.64,36.876a3.019,3.019,0,0,0,.512,3.249l11,8.249c0,1.75-.255,3.249-.255,5s.255,3.249.255,5L4.41,66.623A2.3,2.3,0,0,0,3.9,69.873L14.125,87.124a2.49,2.49,0,0,0,3.069,1l12.785-5a37.211,37.211,0,0,0,8.692,5l2.045,13.249a2.478,2.478,0,0,0,2.557,2H63.73a2.74,2.74,0,0,0,2.557-2l2.048-13.249a43.275,43.275,0,0,0,8.692-5l12.785,5a2.4,2.4,0,0,0,3.069-1l10.228-17.251a3.015,3.015,0,0,0-.512-3.249Zm-38.1,12.5a17.5,17.5,0,1,1,0-35,17.5,17.5,0,1,1,0,35Z" transform="translate(-3.375 -3.375)"/>
                  </svg>
