    ...
    <div class="sidebar">
        ...
        <div class="routes mt-15"> 
            <ul ref="nav">
                ...
                <li @click="$router.push('/courses')" :class="{active:activeRoute.includes('/courses')}">
                ...
                <li @click="$router.push('/reports')" :class="{active:activeRoute.includes('/reports')}" >
                ...
                <li @click="$router.push('/library')" :class="{active:activeRoute.includes('/library')}" >
                ...
                <li @click="$router.push('/quiz')" :class="{active:activeRoute.includes('/quiz')}" >
